...
void setup() {
  ...
  avatars = new Avatar [ 10 ] ;  // reduced from 50 to reduce CPU load
  avatars[0] = new MyCloset(width/4, height/4, 0, 2, 3, 1, 2);
  ...
  avatars[1] = new MyCloset(3*width/4, 3*height/4, 0, 2, 1, 1, 1);
